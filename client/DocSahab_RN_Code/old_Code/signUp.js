...
const signup = () => {
    ...
    // to get the values from the formik states return object
            ...
            <ScrollView 
                ...
                >
                    ...
                    <Formik
                        ...
                        //     actions.resetForm();
                        //     console.log(values);
                        //     () => signUp(values.email, values.password, values.firstName, values.lastName, values.contact, values.city, values.role)
                        // }
                        onSubmit={(values, actions) => {
                            actions.resetForm();
                            console.log(values);
                            // signUp(values.email, values.password, values.firstName, values.lastName, values.contact, values.city, values.role)
                            // values.email, values.password, values.firstName, values.lastName, values.contact, values.city, values.role
                        }
                        }
                        // onSubmit={() => signUp({ email, password, firstName, lastName, contact, city, role })}
                        // onSubmit={() => signUp({ email, password, firstName, lastName, contact, city, role })}
                    >
                    {(props) => (
                            ...
                            <View style={globalStyles.containerColor}>
                                ...
                                <View style={{marginTop: 50}}>
...

                                    {
                                        ...
                                        // onPress={() => signUp(  ) }
                                        // // formik_state_values={props.handleSubmit}
