          ...
          <View style={styles.Sub_Container}>
            <View style={styles.Video_Btns_Container}>
              <TouchableOpacity style={styles.Icon_View}>
                <Icon name={'microphone'} size={34} color="#2A2AC0" />
              </TouchableOpacity>

              <TouchableOpacity style={styles.Icon_View}>
                <Icon name={'camera'} size={34} color="#2A2AC0" />
              </TouchableOpacity>

              <TouchableOpacity style={styles.Icon_View}>
                <Icon name={'phone'} size={34} color="#2A2AC0" />
              </TouchableOpacity>

              <TouchableOpacity style={styles.Icon_View}>
                <Icon name={'comment'} size={34} color="#2A2AC0" />
              </TouchableOpacity>
            </View>
          </View>
        </ImageBackground>
